...
# ==========================================
# إعدادات الأمير المتمرد - ضع التوكن الخاص بك هنا
# ==========================================
TELEGRAM_TOKEN = "8717202916:AAEIbv9g5QUkaXV1jPFQClqkkMWYY93714M" 
...
def action_select(message):
    user_id = message.chat.id
    if 'api_key' not in user_data[user_id]:
    ...
    if mode == 'build':
        bot.send_message(user_id, "أرسل اسم المشروع ووصفاً تفصيلياً لكل ميزة تريدها (مثلاً: نسخة كاملة من فيسبوك):")
    else:
        bot.send_message(user_id, "أرسل الأكواد التي تريد مني فحصها وإصلاحها وتطويرها:")
...
def execute_task(message):
    ...
    if data['mode'] == 'fix':
        ...
        prompt = (
            ...
            "يجب أن يكون الكود شاملاً لكل شيء (Frontend, Backend, Database) "
            "وبدون أي نقص أو اختصار."
        )
...
# تشغيل البوت للأبد
print("The Rebel Prince Factory is Running...")
